...
<div className={`shadow-xl`}>
    <div  className='nav c overflow-hidden w-full nav-main md:pt-8 pt-4  flex  justify-between md:justify-around items-center flex-row flex-shadow-2xl'>
        <h1 className=' mx-2   antialiased  text-lg md:text-3xl font-bold text-green-700 font-second-bold'>HUNTER SOLICITORS</h1>
        <Link onClick={()=>setActive(false)} to='/' exact><div className={`${active?'nav-items-active':'nav-items'} bg-white items-center  md:items-center flex flex-col justify-center md:flex-row md:justify-around list-none w-1/3   flex-shadow-2xl`}></Link
